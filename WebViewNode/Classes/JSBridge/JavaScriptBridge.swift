...
extension DLWebViewJavaScriptBridge {
    public func registerHandler<T: RawRepresentable>(_ handlerType: T,
                                                     handler: @escaping WKWebViewJavascriptBridgeBase.Handler) where T.RawValue == String {
        self.register(handlerName: handlerType.rawValue, handler: handler)
    }

    @discardableResult
    public func removeHandler<T: RawRepresentable>(_ handlerType: T) -> WKWebViewJavascriptBridgeBase.Handler? where T.RawValue == String {
        return self.remove(handlerName: handlerType.rawValue)
    }

    public func callHandler<T: RawRepresentable>(_ handlerType: T, data: Any? = nil,
                                                 responseCallback: WKWebViewJavascriptBridgeBase.Callback? = nil) where T.RawValue == String {
        self.call(handlerName: handlerType.rawValue, data: data, callback: responseCallback)
    }
}
...
public protocol JavaScriptBridge: class {
    ...
    func bindJSBridge(webView: WKWebView)
    ...
    func registerJSHandler(_ handlerKey: String, handler: @escaping WKWebViewJavascriptBridgeBase.Handler)

    /// Remove the handler has been registered by JavaScript with the given key.
    ///
    /// - Parameter handlerKey: The key name of handler.
    func removeJSHandler(_ handlerKey: String) -> WKWebViewJavascriptBridgeBase.Handler?
    ...
    func callJSHandler(_ handlerKey: String, data: Any?, responseCallback: WKWebViewJavascriptBridgeBase.Callback?)
    ...
    ///   - handler: The handler to be called by JavaScript.
    func registerJSHandler<T: RawRepresentable>(_ handlerType: T,
                                                handler: @escaping WKWebViewJavascriptBridgeBase.Handler) where T.RawValue == String
    ...
    ///   - data: The data pass to the JavaScript handler argument.
    ///   - responseCallback: The call back block responded by the JavaScript handler.
    func callJSHandler<T: RawRepresentable>(_ handlerType: T,
                                            data: Any?,
                                            responseCallback: WKWebViewJavascriptBridgeBase.Callback?) where T.RawValue == String
...
extension JavaScriptBridge {
    ...
    public func bindJSBridge(webView: WKWebView) {
        self.jsBridge = DLWebViewJavaScriptBridge(webView: webView)
    }

    public func registerJSHandler(_ handlerKey: String, handler: @escaping WKWebViewJavascriptBridgeBase.Handler) {
        self.jsBridge?.register(handlerName: handlerKey, handler: handler)
    }

    public func removeJSHandler(_ handlerKey: String) -> WKWebViewJavascriptBridgeBase.Handler? {
        return self.jsBridge?.remove(handlerName: handlerKey)
    }

    public func callJSHandler(_ handlerKey: String, data: Any? = nil, responseCallback: WKWebViewJavascriptBridgeBase.Callback? = nil) {
        self.jsBridge?.call(handlerName: handlerKey, data: data, callback: responseCallback)
    }

    public func registerJSHandler<T: RawRepresentable>(_ handlerType: T,
                                                       handler: @escaping WKWebViewJavascriptBridgeBase.Handler) where T.RawValue == String {
    ...
    public func callJSHandler<T: RawRepresentable>(_ handlerType: T,
                                                   data: Any? = nil,
                                                   responseCallback: WKWebViewJavascriptBridgeBase.Callback? = nil) where T.RawValue == String {
...
extension DLWebView: JavaScriptBridge {
    ...
    public func bindJSBridge() {
        self.bindJSBridge(webView: self)
